...
### NOTE THAT THIS VERSION USES SCHILDKRAUT ET AL.'S (1962) EQUATION FOR CALCULATING GC CONTENT FROM DENISITY

#     output = MW.calc.Schildkraut(X, vars=c("density.g.ml", "copies", "tube"))
#
...
#                     the weighted average density of unlabeled DNA is a good proxy for GC content of the taxon, according to the well-known relationship between GC content and the density of DNA (uses equation in Schildkraut et al. 1962)
...
MW.calc.Schildkraut <- function(X, vars=c("density.g.ml", "copies", "tube")){

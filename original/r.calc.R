...
#
#     output = r.calc(X.light, X.heavy, boot.out.light, boot.out.heavy, MW.out, iso.compare, days, var="trt.code", growth.model="exponential", prop.O.from.water=0.50, CI=0.90)
#
...
#     boot.out.light: list containing output from boot.WAD.func or boot.TUBE.func for the 'light' treatment (corresponding to X.light); note that if a linear growth model is used, a list containing output from boot.TUBE.func is required
#     boot.out.heavy: list containing output from boot.WAD.func or boot.TUBE.func for the 'heavy' treatment (corresponding to X.heavy); note that if a linear growth model is used, a list containing output from boot.TUBE.func is required
...
#
#     notes:          requires the functions 'WAD.func', 'boot.WAD.func', 'boot.TUBE.func', 'MW.calc', & 'comparison.message'
...
r.calc <- function(X.light, X.heavy, boot.out.light, boot.out.heavy, MW.out, iso.compare, days, var="trt.code", growth.model="exponential", prop.O.from.water=0.50, CI=0.90){
